...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MyFeathersApp", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("MyFeathersApp", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "MyFeathersApp";
		app.meta["name"] = "MyFeathersApp";
		app.meta["packageName"] = "com.sample.myfeathersapp";
		...
		#elseif air
		app.window.title = "MyFeathersApp";
		#else
